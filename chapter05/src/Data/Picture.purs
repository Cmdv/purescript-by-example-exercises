...
data Shape
  ...
  | Line Point Point
  | Text Point String
  | Clipped Point Number Number Shape

showShape :: Partial => Shape -> String
...
showPicture :: Partial => Picture -> Array String
...
shapeBounds :: Partial => Shape -> Bounds
...
instance showMeShapes :: Partial => Show Shape where
show = showShape 
